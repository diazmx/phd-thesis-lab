...
class PolicyMining:
    ...
    def network_model(self, NETWORK_MODEL_GENERATION=False, USER_NETWORK_PATH=""):
        """
        Performs the network model process generation.

        :param self: A class method.
        
        :param NETWORK_MODEL_GENERATION (bool): True if we perform the new
            methodology for selection the best projection. False if we use a user
            network path instead.

        :param USER_NETWORK_PATH (str): File path for user network model. Only if
            NETWORK_MODEL_GENERATION is True.

        :return user_network (Graph): the user network graph object.
        """
        print("\n#########################")
    ...
    def community_detection(self):
        """
        Docstring for community_detection
