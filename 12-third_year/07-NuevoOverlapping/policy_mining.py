...
from auxiliar_functions.community_detection import sub_community_detection, add_type_commts, calculate_membership_vector, get_membership_vector_statistics
...
class PolicyMining:
    ...
    def network_model(self, networ_analysis_):
        print("\n#########################")
    ...
    def community_detection(self):
        ...
        # --- NUEVA TAREA ---
        ###### ***** TASK 3 ***** #####
        # Calculate community membership vector and identify outsiders
        calculate_membership_vector(self.user_network)
        print("TASK 3: Done!\n")

        ###### ***** TASK 4 ***** #####
        # Calculate statistics for the membership vector
        self.membership_stats = get_membership_vector_statistics(self.user_network)
        print("TASK 4: Done!\n")
