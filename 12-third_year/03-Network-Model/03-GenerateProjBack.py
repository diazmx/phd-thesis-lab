...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 16:42:07 2024

@author: ddiaz

To create all combination between projection techniques and backboning techniques
...
a = time()
name_file_backboning = "top-"+dataset+"-"+projection_name
bb = nb.noise_corrected(g_toy, name_file_backboning)
b = time() - a
